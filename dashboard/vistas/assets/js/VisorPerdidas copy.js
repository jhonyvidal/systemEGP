...
function CrearGraficaVisor(obj,component,label,headers,array,type){
  ...
  $("#btnConsultar").click(function(){
        if( $("#tipoDefiltro").val() === "1"){
            consultaTipoParada();
        }if( $("#tipoDefiltro").val() === "2"){
            consultaActividad();
        }if( $("#tipoDefiltro").val() === "3"){
            consultaProducto();
        }if( $("#tipoDefiltro").val() === "4"){
            consultaRecurso(1);
        }
        if( $("#tipoDefiltro").val() === "5"){
           consultaRecurso(2);
        }
  })
  ...
  function consultaRecurso(id){

    const horasProgramadas = 24;
    const unidadesEsperadas = 100 * 5;

    var datos = new FormData();
	  datos.append("visorRecurso", "");
    datos.append("idEmpresa",$("#idEmpresa").val());
    datos.append("fechaInicio",$("#fechaInicio").val() );
    datos.append("fechaFin", $("#fechaFin").val());
  ...
  $("#tipoDefiltro").change(function(){
    ...
    if(tipo === "1"){
      ...
      $("#selecTipoParada").hide()
      $("#tittleDinamic").html('Visor Por Productos')
    }else if(tipo === "4"){
      $("#selecTipoParada").hide()
      $("#tittleDinamic").html('Visor Por Recursos')
    }else if(tipo === "5"){
      $("#selecTipoParada").hide()
      $("#tittleDinamic").html('Visor Por Procesos')
    }
  })
